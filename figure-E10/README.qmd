...
[R code to generate input files `figure-E9A-LFQ3.csv`, `figure-E9A-Astral14.csv` and `figure-E9A-Astral30.csv`](figure-E9AB-counts.R)
...
[R code to generate input files `figure-E9B-LFQ3.csv`, `figure-E9B-Astral14.csv` and `figure-E9B-Astral30.csv`](figure-E9AB-counts.R)
...
[R code to generate input file `figure-E9C-density.csv`](figure-E9C-density.R)
