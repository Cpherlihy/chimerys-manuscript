...
# ---- intermediate save ----
write.fst(combined, file.path(dataPath, 'data/figure-E6/fst-backup/20241111_figureS8f_sn19_bruker_combined_pcms_localPcmEfdr_apexQuan_entr.fst'), compress = 100)
...
fwrite(mean_efdrSpecBruk, file.path(figurePath, "figure-E6F-spectronaut-bruker.csv"))

# # ---- re-read intermediately saved data ----
# combined <- read.fst(file.path(dataPath, 'data/figure-E6/fst-backup/20241111_figureS8f_sn19_bruker_combined_pcms_localPcmEfdr_apexQuan_entr.fst'), as.data.table = T)
#
# # ---- plot fdr vs efdr ----
