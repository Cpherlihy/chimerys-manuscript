...
# ---- intermediate save ----
write.fst(combined, file.path(dataPath, 'data/figure-E6/fst-backup/20241111_figureS8b_diann_combined_pcms_localPcmEfdr_apexQuan_entr.fst'), compress = 100)
...
fwrite(mean_efdrDiann, file.path(figurePath, "figure-E6B-diann.csv"))

# # ---- re-read intermediately saved data ----
# combined <- read.fst(file.path(dataPath, 'data/figure-E6/fst-backup/20241111_figureS8b_diann_combined_pcms_localPcmEfdr_apexQuan_entr.fst'), as.data.table = T)
#
