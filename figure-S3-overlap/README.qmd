...
This document describes how the data analysis and plots for extended figure 3 were generated. To recreate the figures, make sure to download all input files (available on [PRIDE](https://www.ebi.ac.uk/pride/archive?keyword=PXD053241)), place them under `dataPath` (adjust in `load-dependencies.R` to your own folder structure) and generate intermediate results in the linked `.R` scripts.
...
[R code to generate input file `data_venn_psm_duell.fst`](venn-diagrams.R)
...
[R code to generate input file `data_venn_ptm_native_duell.fst`](venn-diagrams.R)
...
[R code to generate input file `data_venn_ptm_all_duell.fst`](venn-diagrams.R)
