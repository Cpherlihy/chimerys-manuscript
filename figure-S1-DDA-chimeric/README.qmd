...
[R code to generate input file `scans-identified.csv`](figure-S1A-scans-identified.R)
...
[R code to generate input file `psms-per-scan.csv`](figure-S1B-psms-per-scan.R)
