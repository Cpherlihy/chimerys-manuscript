...
[R code to generate input file `figure-E2A-venn-psms.csv`](venn-diagrams.R)
...
[R code to generate input file `figure-E2B-venn-peptides-native.csv`](venn-diagrams.R)
...
[R code to generate input file `figure-E2C-venn-peptides-all.csv`](venn-diagrams.R)
