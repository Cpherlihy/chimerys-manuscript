...
readDiann <- function(pathToTsv, proteinsFromFasta, digest = NULL) {
  ...
  setcolorder(diann, neworder = c('ID', 'PEPTIDE_SEQUENCE', 'PROTEIN_ACCESSION', 'Q_VALUE', 'SVMSCORE', 'DECOY', 'CHARGE', 'MODIFIED_SEQUENCE', 'QUAN', 'SAMPLE', 'FRAGMENTS_USED', 'SPECTRUM_SIMILARITY', 'DIANN_ORGANISM', 'ORGANISM', 'ORGANISM_J', 'ENTRAPMENT', 'ENTRAPMENT_J', 'PCM_ID', 'PCM_J_ID', 'MODPEP_ID', 'MODPEP_J_ID', 'SOFTWARE'))
  diann <- unique(diann)
